...
function config($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, IdleProvider, KeepaliveProvider) {
    ...
    $stateProvider
        ...
        .state('aplicacoes.inversao', {
            url: "/inversao",
            templateUrl: "views/inversao.html",
        ...
        .state('aplicacoes.cadfornecedor', {
            url: "/cadfornecedor",
        ...
        .state('aplicacoes.cadsoldespesa', {
            url: "/cadsoldespesa",
        ...
        .state('aplicacoes.controlegeral', {
            url: "/controlegeral",
        ...
        .state('aplicacoes.cadsupervisor', {
            url: "/cadsupervisor",
        ...
        .state('aplicacoes.supcontrolegeral', {
